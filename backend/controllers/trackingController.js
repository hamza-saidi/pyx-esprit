...
// These routes are public (no JWT - the unguessable token_tracking value is
// the only authorization), so there is no club context from middleware.
// Authorization is by possession of the token, not by tenant; isSystem
// bypass is the deliberate, narrow exception for that reason.
